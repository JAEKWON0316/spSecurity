          ...
          <div class="row">
            ...
            <div class="col-md-6">
                ...
                <address>
                    <ul class="address me-5">
                        ...
                        <li class="py-2 border-bottom"><label>Address : </label>김포시 어딘가</li>
            ...
            <div class="col-md-6">
                <form>
                    ...
                    <div class="mb-3 me-4">
                        <label for="tel" class="form-label">Content</label>
                        <textarea class="form-control" name="" id="" rows="4" placeholder="보내실 말씀"></textarea>
                    </div>
                    <div class="me-3 me-4">
