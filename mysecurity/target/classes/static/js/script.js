    ...
    $('.signup').click(function(e){
     ...
     $("#joinForm").on("submit", function(e){
     	...
     	$("#checkid").click(function(){
     		...
     		window.open("check?usearch="+username+"&check=1", "", "width=450, height=300, top=150, left=400, scrollbars=no");
     		
     		if(win = null){
     			alert("팝업차단설정이 되어있습니다. 브라우저 설정에서 팝업차단을 풀어주세요");
     		}
     	});
     	...
     	$("#checkemail").click(function(){
     		...
     		window.open("check?usearch="+useremail+"&check=2", "", "width=450, height=300, top=150, left=400, scrollbars=no");
